        ...
        //if(mapChange){
            if (lineCoordinatesList != null) {
                for (LineCoordinates lineCoordinates : lineCoordinatesList) {
                    ...
                    borderPaint.setStrokeWidth(110f * zoomFactor);
...
//                nodeY = circleCoordinates.getY();
                    ...
                    String circleColor = "#1069E3";
                    int customCircleColor = Color.parseColor(circleColor);
                    circlePaint.setColor(customCircleColor);
                    canvas.drawCircle(getWidth() - nodeX, getHeight() - nodeY, 20 * zoomFactor, circlePaint);
